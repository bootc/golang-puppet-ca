...
var _ = Describe("the store instance lock", func() {
	...
	// them at a store the holdStore flock does not cover. Added for all four
	// command-driving specs here, not only the newest: the hazard is the same
	// for csr and import-ca-cert.
	BeforeEach(func() {
